...
export default function Home() {
  ...
  return (
    /* 💡 다크모드 방지: 배경색 하얗게, 기본 글씨 까맣게 강제 고정 */
    <main style={{ backgroundColor: '#ffffff', color: '#1a1a1a', minHeight: '100vh', padding: '20px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', margin: '30px 0' }}>
          ...
          <p style={{ color: '#666666', marginTop: '15px', fontSize: '0.95rem' }}>
            원하는 지역과 날짜를 선택해 총 <strong style={{ color: '#000000' }}>{filteredEvents.length}</strong>개의 나들이 정보를 확인해 보세요!
          </p>
        </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              <button 
                ...
                style={{ padding: '8px 16px', backgroundColor: '#0070f3', color: '#ffffff', border: 'none', borderRadius: '6px', fontWeight: 'bold', cursor: 'pointer' }}
              >
                검색
              </button>
            </div>
          ...
          <>
            ...
            {filteredEvents.length === 0 && (
              <div style={{ textAlign: 'center', padding: '60px 20px', color: '#888888', backgroundColor: '#f8f9fa', borderRadius: '16px', marginTop: '20px' }}>
                <strong style={{ color: '#000000' }}>조건에 맞는 이벤트가 없습니다.</strong><br/><br/>다른 지역이나 날짜, 분류를 선택해 보세요!
              </div>
            )}
          </>
        )}
